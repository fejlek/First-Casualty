...
The thing is, we do not want always to sit back there, watch, and predict. Sometimes,
we want to act. Sometimes, we need to act. Causal inference provides us with a
